...
def pre_processing(filename, low_dark_th, low_hot_th, high_dark_th, high_hot_th, \
					...
					output_low, output_high, output_diff, output_sum, mode, crop):
	...
	low, high = kst_io.read_pixirad_data(filename, mode, crop)
	flat_low, flat_high = kst_io.read_pixirad_data(flat_filename, mode, crop)
